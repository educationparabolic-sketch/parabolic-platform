...
- View question details(view question image + solution image)
- Structure Locked + Edit Metadata (option must be there to upload updated solution image inplace of previous one)+ create version + Deprecated selection
- Version history
...
- Phase adherence
- Accuracy trend
- Per-assignment history + Excel Format download per assignment for all students appeared for the assignment which contains each student answers for all questions and whether it was wrong or correct and the raw score  
