...
current_phase: 0
current_task: BWM-009
current_substep: BWM-009 — Remove long-lived ID-token copies from JavaScript-readable cross-domain cookies/localStorage
last_completed_task: BWM-008
next_task: BWM-009
blocked_tasks: []
last_updated: 2026-08-13
last_update_summary: BWM-009 is IN_PROGRESS. Every Vendor or Stripe license mutation now persists one immutable-history-derived licenseVersion across institute/current/compatibility records, projects the new version/layer into all authoritative staff and Student claims, and revokes prior sessions; Stripe retries resume incomplete freshness propagation. Real Auth/Firestore/Functions proof downgraded L3 to L1, updated both identities, rejected an old Admin token with canonical 401, and issued a fresh token carrying the new version. Continue by removing JavaScript-readable cross-domain ID-token copies.
```
...
| BWM-009 | P0 | IN_PROGRESS | BWM-008 | Claims synchronization, revocation, and cross-portal auth hardening |
