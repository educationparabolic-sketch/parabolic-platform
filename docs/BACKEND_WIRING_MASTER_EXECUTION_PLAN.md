...
current_phase: 0
current_task: BWM-006
current_substep: BWM-006 — Define shared success/error envelopes and stable error codes
last_completed_task: BWM-005
next_task: BWM-006
blocked_tasks: []
last_updated: 2026-08-07
last_update_summary: BWM-005 is VERIFIED. CI now validates the exact branch/environment/project/site relationship before build or Firebase tooling, uses public GitHub Environment vars for project/site identifiers, requires the recorded parabolic-dev mapping on dev/staging, and rejects demo or non-production mappings on main. Continue with BWM-006 shared response envelopes and boundary types.
```
...
| BWM-006 | P0 | READY | BWM-002 | Standard response envelope and shared boundary types |
