...
| EXM-01 | `POST /api/v1/exam/session/{sessionId}/entry` | `implemented` | `examSessionEntry` | Firebase ID; student; exact session claims; raw launch credential atomically consumed once; strict candidate-safe runtime snapshot |
