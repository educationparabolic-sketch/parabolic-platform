...
const outDir = "/home/sumeer/parabolic-platform/apps/exam/artifacts/build-134";

const validToken =
  "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJidWlsZC0xMzMuc3R1ZGVudEBwYXJhYm9saWMubG9jYWwiLCJleHAiOjE4OTM0NTYwMDAsIm1vZGUiOiJDb250cm9sbGVkIn0.signature";
...
const scenarios = [
  {
    ...
    routePath: `/session/session-build-134?token=${validToken}`,
    expectedPath: "/session/session-build-134",
    expectedText: "Sync State",
    guardStatus: "PASS",
  ...
  },
  {
    ...
    routePath: "/session/session-build-134",
...
const report = {
  ...
  baseUrl,
  integrationMode: "mocked-answer-endpoint",
  results,
};
