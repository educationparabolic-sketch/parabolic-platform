...
const outDir = "/home/sumeer/parabolic-platform/apps/exam/artifacts/build-133";
...
const scenarios = [
  {
    ...
    routePath: `/session/session-build-133?token=${validToken}`,
    expectedPath: "/session/session-build-133",
    expectedText: "Submit Test",
    guardStatus: "PASS",
  ...
  },
  {
    ...
    routePath: "/session/session-build-133",
