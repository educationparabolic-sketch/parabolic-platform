import type { QuestionBankRecord } from "./testTemplateContract";

export const QUESTION_BANK_FIXTURE_DATA: QuestionBankRecord[] = [
  {
    ...
    fixturePayloadMarker: "PARABOLIC_FIXTURE_PAYLOAD:test-template-question-bank",
    ...
    thermalState: "hot",
    status: "active",
  } as QuestionBankRecord & { fixturePayloadMarker: string },
  {
    academicYear: "2026-27",
    additionalTag: "jee-main",
    examType: "JEEMains",
