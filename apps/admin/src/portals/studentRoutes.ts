...
export const STUDENT_ROUTE_DEFINITIONS: StudentRouteDefinition[] = [
  ...
  },
  {
    ...
    title: "Analytics",
    section: "Analytics",
    description: "Layer-aware student analytics using summary collections rather than raw sessions.",
  },
  {
    path: "/student/analytics/:testId",
    title: "Analytics Detail",
    section: "Analytics",
    description: "Test-specific analytics detail for an individual completed assessment.",
  },
  {
