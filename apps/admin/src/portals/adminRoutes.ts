...
export const ADMIN_ROUTE_DEFINITIONS: AdminRouteDefinition[] = [
  ...
  },
  {
    ...
    section: "Assignments",
    description: "Dedicated historical run summaries for immutable assignment reporting.",
    mountedPath: "/admin/assignments",
    allowedRoles: ["admin", "teacher"],
  },
  {
    ...
    section: "Assignments",
    description: "Dedicated bulk action workspace for duplicate, extend, cancel, terminate, archive, export, and resend flows.",
    mountedPath: "/admin/assignments",
    allowedRoles: ["admin", "teacher"],
  },
  {
  ...
  {
    path: "/admin/insights/monthly-summary",
    title: "AI Monthly Summary",
    section: "Insights",
    description: "Monthly cached advisory summaries for cohorts and students using summary-safe metrics only.",
    allowedRoles: ["admin", "teacher", "director"],
    minimumLicenseLayer: "L1",
    redirectOnDenied: "/admin/overview",
    readOnlyRoles: ["director"],
