...
const outDir = "/home/sumeer/parabolic-platform/apps/admin/artifacts/build-122";

const routes = [
  {
    route: "/admin/analytics/batch",
    expectedPath: "/admin/analytics/batch",
    expectedText: "Cross-Batch Performance, Trends, and Risk Distribution",
    guardStatus: "N/A",
  },
  {
