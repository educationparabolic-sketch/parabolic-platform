...
const outDir = "/home/sumeer/parabolic-platform/apps/vendor/artifacts/build-137";
...
const vendorScenarios = [
  {
    route: "/vendor/institutes",
    expectedPath: "/vendor/institutes",
    expectedText: "Institutes Management",
    guardStatus: "PASS",
  },
  {
    route: "/vendor/licensing",
    expectedPath: "/vendor/licensing",
    expectedText: "Licensing & Subscription Control",
    guardStatus: "PASS",
  },
];
...
async function evaluate(page, scenario) {
  ...
  if (scenario.expectedPath !== scenario.route) {
    try {
      ...
      // Preserve deterministic evidence even when redirect expectation fails.
    }
  }
  await page.waitForTimeout(900);
