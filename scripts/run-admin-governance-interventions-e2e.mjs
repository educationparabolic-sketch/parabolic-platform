...
const environment = {
  ...
  CDN_SIGNED_URL_KEY_NAME: "bwm-029-local-only",
  CDN_SIGNED_URL_KEY_VALUE: Buffer.from("bwm-029-local-test-key")
    .toString("base64url"),
  ...
  VITE_FIREBASE_APP_ID: "1:123456789:web:bwm029governance",
...
function run(command, args, extraEnvironment = {}) {
  console.log(`[admin-governance-interventions] ${command} ${args.join(" ")}`);
...
run("firebase", [
  ...
  "npm run test:e2e:admin-governance-interventions",
]);
