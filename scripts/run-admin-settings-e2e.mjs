...
const environment = {
  ...
  VITE_FIREBASE_APP_ID: "1:123456789:web:bwm030settings",
...
function run(command, args, extraEnvironment = {}) {
  console.log(`[admin-settings] ${command} ${args.join(" ")}`);
...
run("firebase", [
  ...
  "--only", "auth,firestore,functions:apiV1,hosting:portal",
  "npm run test:e2e:admin-settings",
]);
